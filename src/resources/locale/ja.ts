...
Enter one definition per line.</source>
        <translation>これらの定義はグローバルであり、すべてのセッションに読み込まれます。
セッションでは変更できず、セッションエディター内の同名の定義より優先されます。
1 行に 1 つの定義を入力してください。</translation>
    </message>
    <message>
...
Line numbers with errors: %4</source>
        <translation>インポートした変数: %1
インポートした関数: %2
インポートした単位: %3
エラーのある行番号: %4</translation>
    </message>
    <message>
