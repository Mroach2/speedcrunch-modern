...
const QHash<UnitId, UnitSpec>& s_unitSpecs()
{
    ...
    static const QHash<UnitId, UnitSpec> specs = {
        ...
        {UnitId::Ampere, UnitSpec{UnitName::Ampere, QT_TRANSLATE_NOOP("Editor", "Ampere"), UnitSymbol::Ampere, {}, UnitFamily::SiBase, {UnitQuantity::ElectricCurrent}, EngineeringSiPrefixes, &Units::ampere}},
        {UnitId::Kelvin, UnitSpec{UnitName::Kelvin, QT_TRANSLATE_NOOP("Editor", "Kelvin"), UnitSymbol::Kelvin, {}, UnitFamily::SiBase, {UnitQuantity::ThermodynamicTemperature}, EngineeringSiPrefixes, &Units::kelvin}},
        ...
        {UnitId::Candela, UnitSpec{UnitName::Candela, QT_TRANSLATE_NOOP("Editor", "candela"), UnitSymbol::Candela, {}, UnitFamily::SiBase, {UnitQuantity::LuminousIntensity}, EngineeringSiPrefixes, &Units::candela}},
        // SI derived units
        ...
        {UnitId::Hertz, UnitSpec{UnitName::Hertz, QT_TRANSLATE_NOOP("Editor", "Hertz"), UnitSymbol::Hertz, {}, UnitFamily::SiDerived, {UnitQuantity::Frequency}, EngineeringSiPrefixes, &Units::hertz}},
        {UnitId::Newton, UnitSpec{UnitName::Newton, QT_TRANSLATE_NOOP("Editor", "Newton"), UnitSymbol::Newton, {}, UnitFamily::SiDerived, {UnitQuantity::Force}, EngineeringSiPrefixes | SmallPositiveSiPrefixes, &Units::newton}},
        {UnitId::Pascal, UnitSpec{UnitName::Pascal, QT_TRANSLATE_NOOP("Editor", "Pascal"), UnitSymbol::Pascal, {}, UnitFamily::SiDerived, {UnitQuantity::Pressure, UnitQuantity::Stress}, EngineeringSiPrefixes | SmallPositiveSiPrefixes, &Units::pascal}},
        {UnitId::Joule, UnitSpec{UnitName::Joule, QT_TRANSLATE_NOOP("Editor", "Joule"), UnitSymbol::Joule, {}, UnitFamily::SiDerived, {UnitQuantity::Energy, UnitQuantity::Work, UnitQuantity::AmountOfHeat}, EngineeringSiPrefixes, &Units::joule}},
        {UnitId::Watt, UnitSpec{UnitName::Watt, QT_TRANSLATE_NOOP("Editor", "Watt"), UnitSymbol::Watt, {}, UnitFamily::SiDerived, {UnitQuantity::Power, UnitQuantity::RadiantFlux}, EngineeringSiPrefixes, &Units::watt}},
        {UnitId::Coulomb, UnitSpec{UnitName::Coulomb, QT_TRANSLATE_NOOP("Editor", "Coulomb"), UnitSymbol::Coulomb, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricCharge}, EngineeringSiPrefixes, &Units::coulomb}},
        {UnitId::Volt, UnitSpec{UnitName::Volt, QT_TRANSLATE_NOOP("Editor", "Volt"), UnitSymbol::Volt, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricPotentialDifference}, EngineeringSiPrefixes, &Units::volt}},
        {UnitId::Farad, UnitSpec{UnitName::Farad, QT_TRANSLATE_NOOP("Editor", "Farad"), UnitSymbol::Farad, {}, UnitFamily::SiDerived, {UnitQuantity::Capacitance}, EngineeringSiPrefixes, &Units::farad}},
        {UnitId::Ohm, UnitSpec{UnitName::Ohm, QT_TRANSLATE_NOOP("Editor", "Ohm"), UnitSymbol::Ohm, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricResistance}, EngineeringSiPrefixes, &Units::ohm}},
        {UnitId::Siemens, UnitSpec{UnitName::Siemens, QT_TRANSLATE_NOOP("Editor", "Siemens"), UnitSymbol::Siemens, {}, UnitFamily::SiDerived, {UnitQuantity::ElectricConductance}, EngineeringSiPrefixes, &Units::siemens}},
        {UnitId::Weber, UnitSpec{UnitName::Weber, QT_TRANSLATE_NOOP("Editor", "Weber"), UnitSymbol::Weber, {}, UnitFamily::SiDerived, {UnitQuantity::MagneticFlux}, EngineeringSiPrefixes, &Units::weber}},
        {UnitId::Tesla, UnitSpec{UnitName::Tesla, QT_TRANSLATE_NOOP("Editor", "Tesla"), UnitSymbol::Tesla, {}, UnitFamily::SiDerived, {UnitQuantity::MagneticFluxDensity}, EngineeringSiPrefixes, &Units::tesla}},
        {UnitId::Henry, UnitSpec{UnitName::Henry, QT_TRANSLATE_NOOP("Editor", "Henry"), UnitSymbol::Henry, {}, UnitFamily::SiDerived, {UnitQuantity::Inductance}, EngineeringSiPrefixes, &Units::henry}},
        ...
        {UnitId::Lumen, UnitSpec{UnitName::Lumen, QT_TRANSLATE_NOOP("Editor", "lumen"), UnitSymbol::Lumen, {}, UnitFamily::SiDerived, {UnitQuantity::LuminousFlux}, EngineeringSiPrefixes, &Units::lumen}},
        {UnitId::Lux, UnitSpec{UnitName::Lux, QT_TRANSLATE_NOOP("Editor", "lux"), UnitSymbol::Lux, {}, UnitFamily::SiDerived, {UnitQuantity::Illuminance}, EngineeringSiPrefixes, &Units::lux}},
        {UnitId::Becquerel, UnitSpec{UnitName::Becquerel, QT_TRANSLATE_NOOP("Editor", "Becquerel"), UnitSymbol::Becquerel, {}, UnitFamily::SiDerived, {UnitQuantity::ActivityReferredToARadionuclide}, EngineeringSiPrefixes, &Units::becquerel}},
        {UnitId::Gray, UnitSpec{UnitName::Gray, QT_TRANSLATE_NOOP("Editor", "Gray"), UnitSymbol::Gray, {}, UnitFamily::SiDerived, {UnitQuantity::AbsorbedDose, UnitQuantity::Kerma}, EngineeringSiPrefixes, &Units::gray}},
        {UnitId::Sievert, UnitSpec{UnitName::Sievert, QT_TRANSLATE_NOOP("Editor", "sievert"), UnitSymbol::Sievert, {}, UnitFamily::SiDerived, {UnitQuantity::DoseEquivalent}, EngineeringSiPrefixes, &Units::sievert}},
        {UnitId::Katal, UnitSpec{UnitName::Katal, QT_TRANSLATE_NOOP("Editor", "katal"), UnitSymbol::Katal, {}, UnitFamily::SiDerived, {UnitQuantity::CatalyticActivity}, EngineeringSiPrefixes, &Units::katal}},
        ...
        {UnitId::Acre, UnitSpec{UnitName::Acre, QT_TRANSLATE_NOOP("Editor", "acre"), UnitSymbol::Acre, {}, UnitFamily::Other, {UnitQuantity::Area}, NoPrefixes, &Units::acre}},
        ...
        {UnitId::Bar, UnitSpec{UnitName::Bar, QT_TRANSLATE_NOOP("Editor", "bar"), UnitSymbol::Bar, {}, UnitFamily::Other, {UnitQuantity::Pressure}, EngineeringSiPrefixes, &Units::bar}},
        {UnitId::Bit, UnitSpec{UnitName::Bit, QT_TRANSLATE_NOOP("Editor", "bit"), UnitSymbol::Bit, {}, UnitFamily::Other, {UnitQuantity::Information}, PositiveEngineeringSiPrefixes | BinaryIecPrefixes, &Units::bit}},
        ...
        {UnitId::Byte, UnitSpec{UnitName::Byte, QT_TRANSLATE_NOOP("Editor", "byte"), UnitSymbol::Byte, {}, UnitFamily::Other, {UnitQuantity::Information}, PositiveEngineeringSiPrefixes | BinaryIecPrefixes, &Units::byte}},
        ...
        {UnitId::Furlong, UnitSpec{UnitName::Furlong, QT_TRANSLATE_NOOP("Editor", "furlong"), UnitSymbol::Furlong, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::furlong}},
        ...
        {UnitId::Nat, UnitSpec{UnitName::Nat, QT_TRANSLATE_NOOP("Editor", "nat"), UnitSymbol::Nat, {}, UnitFamily::Other, {UnitQuantity::Information}, NoPrefixes, &Units::nat}},
        ...
        {UnitId::Rod, UnitSpec{UnitName::Rod, QT_TRANSLATE_NOOP("Editor", "rod"), UnitSymbol::Rod, {}, UnitFamily::Other, {UnitQuantity::Length}, NoPrefixes, &Units::rod}},
        ...
        {UnitId::Stone, UnitSpec{UnitName::Stone, QT_TRANSLATE_NOOP("Editor", "stone"), UnitSymbol::Stone, {}, UnitFamily::Other, {UnitQuantity::Mass}, NoPrefixes, &Units::stone}},
        ...
        {UnitId::Torr, UnitSpec{UnitName::Torr, QT_TRANSLATE_NOOP("Editor", "Torr"), UnitSymbol::Torr, {}, UnitFamily::Other, {UnitQuantity::Pressure}, NoPrefixes, &Units::torr}},
        ...
        {UnitId::Quad, UnitSpec{UnitName::Quad, QT_TRANSLATE_NOOP("Editor", "quad"), UnitSymbol::Quad, {}, UnitFamily::Other, {UnitQuantity::AmountOfHeat}, NoPrefixes, &Units::quad}},
